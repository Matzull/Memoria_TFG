...
\usepackage[indent]{parskip} % Para que los párrafos tengan sangría y haya un espacio entre ellos
\usepackage{placeins} % Para que las figuras no se salgan de la sección en la que están
\usepackage[acronym]{glossaries}
\usepackage[automake]{glossaries-extra}
\usepackage[spanish]{cleveref} % Para referenciar figuras, tablas, etc. de forma automática
